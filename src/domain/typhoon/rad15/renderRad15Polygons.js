 ...
 *
 **/
export async function renderRad15Polygons(viewer,RADproperty, geojson) {
    ...
    await renderFinalUnionedPolygon(viewer, unioned, {
        color: Cesium.Color.fromBytes(143, 199, 232).withAlpha(0.5),      // 내부 색상 (불투명도 조절 가능)
        outlineColor: Cesium.Color.fromBytes(143, 199, 232),                // 외곽선 색상
    });
